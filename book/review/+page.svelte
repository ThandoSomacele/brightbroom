...
<script lang="ts">
    ...
    import { Calendar, MapPin, Clock, CreditCard, FileText, ArrowLeft } from 'lucide-svelte';
  ...
  <div class="min-h-screen bg-gray-50 px-4 py-8 dark:bg-gray-900">
    <div class="mx-auto max-w-5xl">
      ...
      <div class="mb-8 text-center">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Review Your Booking</h1>
      ...
      <div class="mb-8 grid gap-6 md:grid-cols-2">
        ...
        <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Service Details</h2>
          
          {#if serviceDetails}
            <div>
              <h3 class="text-lg font-medium text-gray-900 dark:text-white">{serviceDetails.name}</h3>
              <p class="mt-1 text-gray-600 dark:text-gray-300">{serviceDetails.description}</p>
          ...
          {:else}
            <p class="text-gray-500 dark:text-gray-400">Service information not available</p>
          {/if}
        </div>
        
        <!-- Schedule and location -->
        <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Schedule & Location</h2>
          ...
          <div class="space-y-4">
            <div class="flex items-start">
              ...
              <div>
                ...
                <p class="text-gray-600 dark:text-gray-300">{formatDate(selectedDate)}</p>
              </div>
            </div>
            ...
            <div class="flex items-start">
              ...
              <div>
                ...
                <p class="text-gray-600 dark:text-gray-300">{formatTime(selectedTime)}</p>
              </div>
            </div>
            ...
            {:else}
              <p class="text-gray-500 dark:text-gray-400">Address information not available</p>
            {/if}
          </div>
        </div>
      </div>
      ...
      {#if notes}
        <div class="mb-8 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          <h2 class="mb-3 flex items-center text-xl font-semibold text-gray-900 dark:text-white">
      ...
      <div class="mb-8 rounded-lg bg-primary-50 p-6 dark:bg-primary-900/20">
        <div class="flex items-center justify-between">
          <h2 class="text-xl font-semibold text-gray-900 dark:text-white">Total</h2>
        ...
        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
          Prices include VAT and cleaning supplies. Payment will be processed securely via PayFast.
        </p>
      </div>
      ...
      >
        ...
        <div class="flex justify-between">
          ...
          <Button 
            type="submit"
            variant="primary" 
            disabled={isLoading || !selectedService || !selectedAddress || !selectedDate || !selectedTime}
          >
            {#if isLoading}
