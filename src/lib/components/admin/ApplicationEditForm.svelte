...
<script lang="ts">
  ...
  let selectedExperienceTypes: string[] = (editableApplication?.experienceTypes || []) as string[];
  ...
  {#if isEditing && editableApplication}
    <div class="bg-blue-50 dark:bg-blue-900/20 p-4 rounded-md mb-4">
      <p class="text-blue-700 dark:text-blue-300 text-sm">
        You are editing this application. Make your changes and click Save to update.
      </p>
    </div>
    ...
    <div class="grid gap-6 md:grid-cols-2">
      ...
      <div class="space-y-4">
        <h3 class="text-lg font-medium text-gray-900 dark:text-white">Location & Work Information</h3>
        ...
        <div>
          ...
          {#if isOutOfServiceArea}
            <p class="mt-1 text-sm text-amber-600 dark:text-amber-400">
              This address is outside our service areas, but can still be approved.
            </p>
          {/if}
        </div>
    ...
    <!-- Experience Types -->
    <div>
      <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Experience Types</h3>
    ...
    <!-- Availability -->
    <div>
      <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-2">Availability</h3>
