...
type TestEmailType = 'welcome' | 'password-reset' | 'booking-confirmation' | 'reminder';

/**
 * Send a test email - FOR DEVELOPMENT USE ONLY
 */
export async function sendTestEmail(type: TestEmailType, to: string): Promise<{success: boolean, id?: string, error?: any}> {
  ...
  try {
    ...
    let html = '<h1>This is a test email</h1><p>Your email integration is working!</p>';
    ...
    switch (type) {
      case 'welcome':
        ...
        text = 'Welcome to BrightBroom! This is a test welcome email. If you received this, your email integration is working correctly.';
        break;
      ...
      case 'password-reset':
        ...
        html = `<h1>Password Reset</h1>
               ...
               <p>If you received this, your email integration is working correctly.</p>`;
        text = 'Password Reset. This is a test password reset email. If you received this, your email integration is working correctly.';
        break;
      ...
      case 'booking-confirmation':
        ...
        html = `<h1>Booking Confirmation</h1>
               ...
               <p>If you received this, your email integration is working correctly.</p>`;
        text = 'Booking Confirmation. This is a test booking confirmation email. If you received this, your email integration is working correctly.';
        break;
      ...
      case 'reminder':
        ...
        html = `<h1>Booking Reminder</h1>
               ...
               <p>If you received this, your email integration is working correctly.</p>`;
        text = 'Booking Reminder. This is a test booking reminder email. If you received this, your email integration is working correctly.';
        break;
    }

    // Send the test email
    const { data, error } = await resend.emails.send({
      from: 'onboarding@resend.dev', // Using Resend's test sender (or your verified domain)
      to,
      subject,
      html,
      text,
