  ...
  <div class="min-h-screen bg-gray-50 px-4 py-8 dark:bg-gray-900">
    <div class="mx-auto max-w-5xl">
      ...
      <div class="mb-8 text-center">
        <h1 class="text-3xl font-bold text-gray-900 dark:text-white">Select Address</h1>
      ...
      <!-- Address selection -->
      <div class="mb-8">
        <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Your Addresses</h2>
        
        {#if addresses.length === 0}
          <div class="mb-6 rounded-lg border border-dashed border-gray-300 bg-white p-8 text-center dark:border-gray-700 dark:bg-gray-800">
            ...
            <p class="mb-4 text-gray-600 dark:text-gray-400">
              You haven't added any addresses yet. Add an address to continue with your booking.
            </p>
            <Button 
              variant="primary" 
        ...
        {:else}
          <div class="grid gap-4 md:grid-cols-2">
            ...
            <div 
              ...
              on:click={() => goto('/profile/addresses/new?redirectTo=/book/address')}
              on:keydown={(e) => e.key === 'Enter' && goto('/profile/addresses/new?redirectTo=/book/address')}
              role="button"
              tabindex="0"
            >
              ...
              <h3 class="mb-1 text-lg font-medium text-gray-900 dark:text-white">Add New Address</h3>
      ...
      {#if addresses.length > 0}
        <div class="mb-8">
          <h2 class="mb-4 text-xl font-semibold text-gray-900 dark:text-white">Access Instructions (Optional)</h2>
