...
export const PATCH: RequestHandler = async ({ request, params, locals }) => {
  ...
  try {
    ...
    const allowedFields = [
      ...
      'formattedAddress', 'latitude', 'longitude', 'workRadius',
      'experienceTypes', 'availability', 'ownTransport', 'whatsApp',
      'idType', 'idNumber', 'bio', 'petCompatibility', 'notes'
    ];
    ...
    const [updatedApplication] = await db.update(cleanerApplication)
      .set(updateData)
