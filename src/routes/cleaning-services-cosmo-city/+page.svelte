...
<svelte:head>
  ...
  <meta
    name="description"
    content="Affordable and professional home and office cleaning services in Cosmo City, Roodepoort. Book trusted cleaners for regular or deep cleaning. Serving Cosmo City, Zandspruit, Diepsloot, and surrounding areas."
  />
  <meta
    name="keywords"
    content="cleaning services Cosmo City, house cleaning Cosmo City, office cleaning Cosmo City, domestic cleaning Cosmo City, cleaners near me Cosmo City, affordable cleaning Cosmo City, maid service Cosmo City, home cleaning Roodepoort"
  />

  <!-- Open Graph / Facebook -->
  <meta
    property="og:title"
    content="Professional Cleaning Services in Cosmo City | BrightBroom"
  />
  <meta
    property="og:description"
    content="Book affordable and trusted cleaning services in Cosmo City. Professional cleaners for your home or office. Easy online booking."
  />
  <meta property="og:type" content="website" />
  <meta
    property="og:url"
    content="https://brightbroom.com/cleaning-services-cosmo-city"
  />
  <meta
    property="og:image"
    content="https://brightbroom.com/images/brightbroom-og-image.jpg"
  />
  ...
  <meta
    ...
    content="Book affordable and trusted cleaning services in Cosmo City. Professional cleaners for your home or office."
  />
  <meta
    name="twitter:image"
    content="https://brightbroom.com/images/brightbroom-og-image.jpg"
  ...
  <div class="max-w-4xl mx-auto">
    ...
    <section class="mb-12">
      ...
      <p class="text-xl text-gray-600 mb-8">
        Your trusted affordable cleaning service serving Cosmo City and
        surrounding areas including Zandspruit, Diepsloot, Honeydew, and
        Randburg.
      </p>
    ...
    <section class="mb-12 bg-primary-50 rounded-lg p-8">
      ...
      <p class="text-gray-700 mb-4">
        BrightBroom is proud to serve the diverse and vibrant Cosmo City
        community. We understand the unique needs of this integrated township
        and work with local cleaners who know the area well.
      </p>
      <p class="text-gray-700 mb-4">
        Our cleaners are familiar with the different residential sections,
        apartment complexes, and townhouse developments throughout Cosmo City.
        We provide the same high-quality service whether you're in the
        subsidized housing area or private developments.
      </p>
      <p class="text-gray-700">
        With extended coverage reaching Zandspruit, Diepsloot, Honeydew, and
        beyond, we're committed to making professional cleaning services
        accessible and affordable for everyone in the area.
      </p>
    </section>
    ...
    <section class="text-center py-8 bg-gray-900 text-white rounded-lg">
      ...
      <p class="text-xl mb-8 text-gray-300">
        Join our growing community of satisfied customers in Cosmo City who
        trust BrightBroom for affordable, professional cleaning.
      </p>
      <div class="flex flex-wrap gap-4 justify-center">
        ...
        <Button
          href="/contact"
          size="lg"
          class="!bg-transparent !border-2 !border-white !text-white hover:!bg-white hover:!text-gray-900 focus:ring-white"
        >
          Get a Quote
        </Button>
      </div>
