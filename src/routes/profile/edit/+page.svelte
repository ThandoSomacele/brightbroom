...
<div class="min-h-screen bg-gray-50 px-4 py-8 dark:bg-gray-900">
  <div class="mx-auto max-w-3xl">
    <div class="mb-8">
      ...
      <p class="mt-2 text-gray-600 dark:text-gray-300">Update your personal information</p>
    </div>
    ...
    <div class="rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
      ...
      <div class="mt-8 border-t border-gray-200 pt-6 dark:border-gray-700">
        <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-white">Change Password</h3>
        <p class="mb-4 text-sm text-gray-600 dark:text-gray-400">
          To update your password, click the button below. You'll be sent to a separate page.
        </p>
        <Button 
          variant="outline" 
