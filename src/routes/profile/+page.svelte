          ...
          <div class="mb-6 border-t border-gray-200 pt-6 dark:border-gray-700">
            ...
            <div class="space-y-3">
              ...
              <div>
                ...
                >
                <span
                  class="inline-flex items-center rounded-full bg-primary-50 px-2.5 py-0.5 text-sm font-medium text-primary dark:bg-primary-900/20"
                >
                  {user.role === "CUSTOMER"
                    ? "Customer"
                    : user.role === "CLEANER"
          ...
          <div class="space-y-3">
            ...
            <form method="POST" action="/auth/logout">
              <Button
                variant="ghost"
                type="submit"
                class="w-full justify-start text-red-600 hover:text-red-700 dark:text-red-400 dark:hover:text-red-300"
              >
                <svg
        ...
        <div class="mb-8 rounded-lg bg-white p-6 shadow-md dark:bg-gray-800">
          ...
          <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 md:grid-cols-3">
            ...
            >
              ...
              <span class="mt-1 text-sm text-white/80"
                >Manage recurring services</span
              >
            </Button>
          </div>
        </div>
